<div class="sticky w-full z-20 top-0 left-0 mt-24 bg-gray-100 border-gray-200">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://flowbite.com/" class="hover:underline">Flowbite CSS</a>
                            </li>
                            <li>
                                <a href="https://tailwindcss.com/" class="hover:underline">Recommended</a>
                            </li>
                        </ul>
                    </div>
                    <div>
